...
- 1. query: **vector** "glasgow", return "Celtic feast journal" which has "Scotland written in content"
- 2. query: **vector** "glasgow", return "Celtic feast journal" which has "Scotland written in content"
- 3. query: **vector** "shortbread", returns "Celtic feast journal" as "shortbread" is related to "scotland"
- 4. query: **keyword/full-text** "shubham", returns "Physics Refresher" which has author name "Shubham Thorve"
- 5. query: **keyword/full-text** "mayank", returns "Digit Gaming" which has author name "Mayank Khurana"
- 6. query: **keyword/full-text** "month", returns "Dalal Street Journal" which has content "All about video games this month"
